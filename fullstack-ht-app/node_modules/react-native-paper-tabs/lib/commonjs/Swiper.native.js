...
function SwiperNative(props) {
  ...
  const indexRef = React.useRef(defaultIndex || 0);
  const [index, setIndex] = React.useState(defaultIndex || 0);
  let children = props.children;
  const offset = React.useRef(new _reactNative.Animated.Value(0));
  const position = React.useRef(new _reactNative.Animated.Value(defaultIndex || 0));
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_TabsHeader.default, renderProps), /*#__PURE__*/React.createElement(_context.TabsContext.Provider, {
    value: {
      goTo,
      index
    }
  }, /*#__PURE__*/React.createElement(_reactNativePagerView.default, {
  ...
  }, React.Children.map(children, (tab, tabIndex) => /*#__PURE__*/React.createElement(_reactNative.View, {
    style: styles.viewPager,
